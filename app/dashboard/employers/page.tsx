    ...
    <DashboardLayout>
      <div className="space-y-6">
        ...
        <div className="flex items-end justify-between">
          <div>
            <h1 className="text-3xl font-extrabold text-[#3a9295]">Employers</h1>
        ...
        {/* Gradient summary */}
        <div
          className="rounded-[10px] p-5 sm:p-6 grid grid-cols-3 shadow-[0_8px_24px_rgba(58,146,149,0.25)]"
          style={primaryStyle}
        >
                  ...
                  <div className="p-5">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span
                            className={`w-2 h-2 rounded-full flex-shrink-0 ${
                              emp.isActive ? 'bg-[#3A9295]' : 'bg-gray-300 dark:bg-gray-600'
                            }`}
                          />
                          {emp.id === defaultEmployerId && (
                            <span className="inline-flex items-center gap-1 text-[9px] font-bold uppercase tracking-widest text-[#105f68] bg-[#105f68]/10 rounded-full px-2 py-0.5 flex-shrink-0">
                              <Star className="h-2.5 w-2.5 fill-[#105f68]" /> Default
                            </span>
                          )}
                        </div>
                    ...
                    <div className="grid grid-cols-2 rounded-lg bg-[#3a9295]/[0.04] dark:bg-white/5 border border-[#3a9295]/[0.06] dark:border-white/5 p-3 mb-4">
                      ...
                      <div className="text-center border-l border-[#3a9295]/[0.06] dark:border-white/5">
                        ...
                        <p className="font-mono text-base font-semibold text-[#3a9295] dark:text-[#c8e6e2]">{money(totalPay)}</p>
                      </div>
                    </div>
                    ...
                    <button
                      ...
                      className={`w-full flex items-center justify-center gap-1.5 py-2 mb-2 rounded-md text-[11px] font-bold uppercase tracking-widest transition-colors ${
                        emp.id === defaultEmployerId
                          ? 'bg-[#105f68]/10 text-[#105f68] cursor-default'
                          : 'border border-[#105f68]/25 text-[#105f68] hover:bg-[#105f68]/[0.06]'
                      } disabled:opacity-60`}
                    >
                      {settingDefault === emp.id ? (
                        <Loader2 className="h-3.5 w-3.5 animate-spin" />
                      ) : (
                        <Star className={`h-3.5 w-3.5 ${emp.id === defaultEmployerId ? 'fill-[#105f68]' : ''}`} />
                      )}
        ...
        <div className="space-y-5">
          ...
          <label className="flex items-center gap-3 cursor-pointer select-none">
            <input
              ...
              className="h-4 w-4 accent-[#3a9295]"
            />
          ...
          <div className="space-y-2.5">
            {targetShifts.map((sal) => {
              ...
              return (
                <div
                  key={sal.id}
                  className="rounded-lg border border-[#3a9295]/[0.08] dark:border-white/10 p-3.5 flex items-center justify-between gap-3"
                >
                  ...
                  <div className="text-right flex-shrink-0">
                    <span className="font-mono font-bold text-[#3a9295] dark:text-[#c8e6e2]">
                      {money(sal.salary)}
                    </span>
