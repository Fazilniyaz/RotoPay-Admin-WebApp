...
const secondaryBtn =
  'flex items-center justify-center gap-2 px-5 py-3 text-[11px] font-bold uppercase tracking-widest rounded-lg border border-[#2563eb]/20 text-[#2563eb] dark:text-[#dbeafe] hover:bg-[#2563eb]/[0.06] transition-all disabled:opacity-60';
    ...
    <DashboardLayout>
      <div className="space-y-8">
        ...
        <div className="flex items-end justify-between gap-3 flex-wrap">
          <div>
            <h1 className="text-3xl font-extrabold text-[#2563eb]">Shifts</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {filteredWages.map((w) => (
                <div key={w.id} className={`${cardCls} p-5`}>
                  ...
                  <div className="flex items-center justify-between border-t border-[#2563eb]/[0.06] dark:border-white/5 pt-3">
                    <span className="text-[10px] font-bold uppercase tracking-wider text-[#707783] dark:text-gray-400">
                      Per day {money(w.salary)}
                    </span>
                    <span className="font-mono text-lg font-semibold text-[#2563eb] dark:text-[#dbeafe]">
                      {wageAmount(w)}
                    </span>
                  </div>
              ...
              <div key={shift.id} className={`${cardCls} overflow-hidden`}>
                ...
                <div className="p-5">
                  ...
                  <div className="grid grid-cols-2 rounded-lg bg-[#2563eb]/[0.04] dark:bg-white/5 border border-[#2563eb]/[0.06] dark:border-white/5 p-3 mb-4">
                    <div className="text-center border-r border-[#2563eb]/[0.06] dark:border-white/5">
        ...
        <div className="space-y-5">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <div className={`${inputCls} font-mono bg-gray-100 dark:bg-gray-800/60 text-[#2563eb] dark:text-[#dbeafe]`}>
                {formHours}h
              </div>
            </div>
            <div>
              ...
              {SHIFT_COLORS.map((c) => (
                <button
                  ...
                  className={`w-8 h-8 rounded-full transition-transform ${
                    form.color === c ? 'ring-2 ring-offset-2 ring-[#2563eb] scale-110 dark:ring-offset-[#1f2937]' : 'hover:scale-105'
                  }`}
                  style={{ background: c }}
                />
              ))}
        ...
        <div className="space-y-5">
          ...
          <div>
            ...
            <div className={`${inputCls} flex items-center justify-between bg-gray-100 dark:bg-gray-800/60 cursor-not-allowed`}>
              <span className="font-mono text-[#2563eb] dark:text-[#dbeafe]">
          ...
          <div className="rounded-lg bg-[#2563eb]/[0.05] dark:bg-white/5 border border-[#2563eb]/[0.08] dark:border-white/10 p-4 flex items-center justify-between">
            <div>
            ...
            <span className="font-mono text-xl font-semibold text-[#2563eb] dark:text-[#dbeafe]">
              {wagePerDay == null
                ? '—'
